...
sed -i 's/HOOKS=(base udev autodetect modconf block filesystems keyboard fsck)/HOOKS=(base udev keyboard autodetect numlock modconf block encrypt filesystems fsck)/' /etc/mkinitcpio.conf
